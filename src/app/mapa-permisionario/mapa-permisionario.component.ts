...
@Component({
  selector: 'app-mapa-permisionario',
  templateUrl: './mapa-permisionario.component.html',
  styleUrls: ['./mapa-permisionario.component.css']
})
export class MapaPermisionarioComponent implements OnInit {
